preferences {
	...
	input("devicename", "text", title: "Device Name:", description: "Name of your neviweb® dimmer")
}

metadata {
	definition (name: "Sinopé Technologies Dimmer", namespace: "Sinopé Technologies", author: "Vanessa Pepin") {
		capability "Switch"
